...
export default function DswdEncodedPage() {
  ...
  const fetchApplicants = async () => {
    ...
    setError("");
    try {
      const response = await fetch("/api/dswd_applicant/claimed");
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">DSWD Claimed Applicants</h1>
          <p className="text-gray-600">Manage Claimed DSWD records.</p>
        </div>
      </div>
